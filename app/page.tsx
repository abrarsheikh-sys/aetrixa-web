      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-24">
          {products.map((product) => (
            <div key={product.id} className="bg-white p-6 shadow-xl rounded-2xl transition-all hover:shadow-2xl">
              ...
              <a href={product.affiliateLink} target="_blank" rel="noopener noreferrer" className="block text-center bg-black text-white py-4 rounded-xl hover:bg-yellow-600 transition-colors uppercase font-bold text-sm tracking-widest">
                Buy Now
              </a>
            </div>
          ))}
        ...
        <div className="max-w-3xl mx-auto bg-white p-10 rounded-3xl shadow-2xl border border-gray-100">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-black uppercase tracking-widest">Reserve Your Experience</h2>
